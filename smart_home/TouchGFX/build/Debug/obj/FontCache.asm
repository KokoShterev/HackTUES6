; Listing generated by Microsoft (R) Optimizing Compiler Version 19.27.29112.0 
	...
	TITLE	D:\stm_gfx_hacktues_project\smart_home_v2\smart_home\TouchGFX\generated\fonts\src\FontCache.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__8EB047FE_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1OM@OLMCILEN@?$AAD?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA_?$AAg?$AAf?$AAx?$AA_?$AAh?$AAa?$AAc?$AAk@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1OM@OLMCILEN@?$AAD?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA_?$AAg?$AAf?$AAx?$AA_?$AAh?$AAa?$AAc?$AAk@
CONST	SEGMENT
??_C@_1OM@OLMCILEN@?$AAD?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA_?$AAg?$AAf?$AAx?$AA_?$AAh?$AAa?$AAc?$AAk@ DB 'D'
...
; _this$ = ecx
; File D:\stm_gfx_hacktues_project\smart_home_v2\smart_home\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 60
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __2DFE1F02_CachedFont@hpp
...
; _this$ = ecx
; File D:\stm_gfx_hacktues_project\smart_home_v2\smart_home\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 372
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __8EB047FE_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 373
	mov	eax, DWORD PTR _this$[ebp]
...
$LN3@assertVali:
	mov	esi, esp
	push	177					; 000000b1H
	push	OFFSET ??_C@_1OM@OLMCILEN@?$AAD?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA_?$AAg?$AAf?$AAx?$AA_?$AAh?$AAa?$AAc?$AAk@
...
; _this$ = ecx
; File D:\stm_gfx_hacktues_project\smart_home_v2\smart_home\Middlewares\ST\touchgfx\framework\include\touchgfx\Font.hpp
; Line 388
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __50034995_Font@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 389
	xor	eax, eax
; Line 390
